    ...
    <div>
      <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
        ...
        {/* <div className="flex flex-col justify-center items-center bg-[var(--trans-teal)] rounded-2xl">
          ...
          <button className="flex items-center body-text text-[var(--forest-green)] bg-[var(--trans-teal)] mb-3 px-1 py-1 rounded hover:animate-pulse" onClick={handleOpen}>
            View
            <Image
              src='/img/expand.svg'
              height={35}
        ...
        <div className="bg-white mt-8 grid grid-cols-1 gap-y-12 sm:grid-cols-2 sm:gap-x-6 lg:grid-cols-4 xl:gap-x-8">
